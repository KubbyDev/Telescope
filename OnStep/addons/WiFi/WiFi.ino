...
char wifi_sta_ssid[40] = "MyOnstep";  //DJ WIFI
char wifi_sta_pwd[40] = "david1969";  //DJ WIFI
...
//DJ WIFI MY CONFIG (wifi generated by mobile phone)
IPAddress wifi_sta_ip = IPAddress(192, 168, 43, 100);
IPAddress wifi_sta_gw = IPAddress(192, 168, 43, 1);

//DJ WIFI MY CONFIG (wifi generated by PC)
// IPAddress wifi_sta_ip = IPAddress(192, 168, 137, 100);
// IPAddress wifi_sta_gw = IPAddress(192, 168, 137, 1);
...
TryAgain:
  ...
  VF("WEM: WiFi local IP      = "); VL(WiFi.localIP().toString());    //DJ WIFI
