...
//DJ modifications perso


#if defined(__MK64FX512__) || defined(__MK66FX1M0__) || defined(__IMXRT1062__)		//DJ

// The multi-purpose pins (Aux3..Aux8 can be analog pwm/dac if supported)
#define Aux0                  23     // Status LED								//DJ
...
#define PecPin                21 //DJ
#define AnalogPecPin          21     // PEC Sense, analog or digital
